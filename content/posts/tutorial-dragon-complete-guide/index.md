...
V levém menu vyberte scripty itemů. Vyberme "All" (všechny), kromě grass (trávy). Po kliknutí **Start** se program zeptá, zda chcete smazat staré statické itemy — vždy odpovězte **ANO**.
